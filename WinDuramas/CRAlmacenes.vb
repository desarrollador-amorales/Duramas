...
Namespace WinDuramas
    
    Public Class CRAlmacenes
        ...
        Public Overrides Property FullResourceName() As String
            Get
                Return "WinDuramas.CRAlmacenes.rpt"
            End Get
            Set
                'Do nothing
            End Set
        ...
        <Browsable(false),  _
         DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
        Public ReadOnly Property Parameter_Parametro1() As CrystalDecisions.[Shared].IParameterField
            Get
    ...
    Public Class CachedCRAlmacenes
        Inherits Component
        ...
        Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
            Dim rpt As CRAlmacenes = New CRAlmacenes()
            rpt.Site = Me.Site
            Return rpt
        End Function
